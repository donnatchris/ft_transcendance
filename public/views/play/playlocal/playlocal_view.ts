export const PlayLocal = (): string => `
<div id="local_view" class="h-full w-full justify-center">

	<div id="button_join_div" class="flex items-center justify-center font-press-start text-xl gap-4 h-full">
	 	<form id="flocal" class="flex items-center">
			<button type="submit" class="transition duration-300 ease-in-out transform hover:scale-105 font-tomorrow font-bold text-4xl border border-white px-6 py-3 rounded-lg">Join Local</button>
		</form>
	</div>
	...
	<div id="gameScreenDiv" class="h-full hidden">
		<div class="flex items-center justify-between font-press-start text-xl gap-4">
			<div class="flex flex-col items-center">
				<span id="current_user">PLAYER 1</span>
	...
	<div id="scoresEnd" class="w-full max-w-md mx-auto flex flex-col items-center space-y-6 p-6 bg-gray-900 rounded-xl border border-gray-700 hidden">
		...
		<form id="rlocal" class="flex items-center">
